...
const morganTinyWhenNotHttpPOST = morgan('tiny', {
  // skip this use of morgan if the method is a POST request
  // i.e. we use tiny for everything except POST methods
  skip: function (req, res) {return req.method === 'POST'}
})

const morganCustomForHttpPOST = morgan(':method :url :status :res[content-length] - :response-time ms :post', {
...
module.exports = {
  requestLogger,
  morganTinyWhenNotHttpPOST,
  morganCustomForHttpPOST,
